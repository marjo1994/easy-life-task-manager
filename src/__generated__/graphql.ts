...
export type GetTasksQuery = { __typename?: 'Query', tasks: Array<{ __typename?: 'Task', id: string, name: string, pointEstimate: PointEstimate, dueDate: any, status: Status, tags: Array<TaskTag>, assignee?: { __typename?: 'User', id: string, fullName: string } | null }> };

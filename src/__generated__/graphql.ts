...
export type CreateTaskMutation = { __typename?: 'Mutation', createTask: { __typename?: 'Task', id: string, name: string, status: Status, pointEstimate: PointEstimate, tags: Array<TaskTag>, dueDate: any, position: number, assignee?: { __typename?: 'User', id: string, fullName: string } | null } };
...
export type UpdateTaskMutation = { __typename?: 'Mutation', updateTask: { __typename?: 'Task', id: string, name: string, status: Status, pointEstimate: PointEstimate, tags: Array<TaskTag>, dueDate: any, position: number, assignee?: { __typename?: 'User', id: string, fullName: string } | null } };
...
export type GetTasksQuery = { __typename?: 'Query', tasks: Array<{ __typename?: 'Task', id: string, name: string, pointEstimate: PointEstimate, dueDate: any, status: Status, tags: Array<TaskTag>, position: number, assignee?: { __typename?: 'User', id: string, fullName: string } | null }> };
